...
<body>
    ...
    <section class="text-gray-600 body-font">
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">1 Bench press</h1>
            <img src="fitness_images/chestimg/bench-press.jpg" alt="" class="exerciseimg">
            <div class="text-center lg:w-2/3 w-full">
                <p style="color: black;
    font-weight: bold;
    font-size: larger;"> Sets 5 Reps 5 Tempo 10X0 Rest 60sec</p>
                <p class="mb-8 leading-relaxed">



                    Lie on a flat bench holding a barbell with your hands slightly wider than shoulder-width apart.
                    Brace your core, then lower the bar towards your chest. Press it back up to the start..</p>
            </div>
        </div>
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">2 Incline bench press</h1>
            <img src="fitness_images/chestimg/incline-bench-press.jpg" alt="" class="exerciseimg">
            <div class="text-center lg:w-2/3 w-full">
                <p style="color: black;
    font-weight: bold;
    font-size: larger;">Sets 5 Reps 5 Tempo 10X0 Rest 60sec</p>
        ...
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">3 Incline dumbbell press</h1>
            <img src="fitness_images/chestimg/incline-dumbbell-bench-press.jpg" alt="" class="exerciseimg">
            <div class="text-center lg:w-2/3 w-full">
                <p style="color: black;
    font-weight: bold;
    font-size: larger;"> Sets 4 Reps 8 Tempo 2010 Rest 20sec</p>
                <p class="mb-8 leading-relaxed">
                    ...
                    Lie on an incline bench holding a dumbbell in each hand by your shoulders. Brace your core, then
                    press the weights up until your arms are straight. Lower them back to the start.</p>
            </div>
        </div>
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">4 Incline dumbbell flye</h1>
            <img src="fitness_images/chestimg/incline-dumbbell-flye.jpg" alt="" class="exerciseimg">
            <div class="text-center lg:w-2/3 w-full">
                <p style="color: black;
    font-weight: bold;
    font-size: larger;">Sets 4 Reps 10 Tempo 2111 Rest 20sec</p>
                <p class="mb-8 leading-relaxed">

                    Lie on an incline bench holding a dumbbell in each hand above your face, with your palms facing and
                    a slight bend in your elbows. Lower them to the sides, then bring them back to the top.</p>
            </div>
        </div>
        <div class="container mx-auto flex px-5 py-15 items-center justify-center flex-col">
            <h1 class="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900">5 Press-up</h1>
            <img src="fitness_images/chestimg/press-up.jpg" alt="" class="exerciseimg">
            <div class="text-center lg:w-2/3 w-full">
                <p style="color: black;
    font-weight: bold;
    font-size: larger;"> Sets 4 Reps 12 Tempo 2010 Rest 60sec</p>
                <p class="mb-8 leading-relaxed">
                    Get into position with your feet together and hands underneath your shoulders. Brace your core so
